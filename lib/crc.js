...
}(this, function()
{
  ...
  function crc8Stream(stream, callback)
  {
    var crc = 0;

    stream.on("data", function(data) {
      for (var i = 0, len = data.length; i < len; ++i) {
        crc = crc8Add(crc, data[i]);
      }
    });
  ...
  function crcModbusString(str)
  {
    ...
    var i, len = str.length, crc = 65535;
  ...
  function crc16Stream(stream, callback)
  {
    var crc = 0;
  ...
  function fcs16(str)
  {
    var i, len = str.length, fcs = 0xFFFF;
  ...
  function crc32(str) {
    var i, len = str.length, crc = 0xFFFFFFFF;
  ...
  function crc32Stream(stream, callback) {
    var crc = 0xFFFFFFFF;

    stream.on("data", function(data) {
      for (var i = 0, len = data.length; i < len; ++i) {
        crc = crc32Add(crc, data[i]);
      }
    });
  ...
  function crc16CCITT(str) {
    var i, len = str.length, crc = 0xFFFF;
